        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourDuration = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LuggageStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightTickets_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceToVisitName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    TypeOfTransportation = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    TourDuration = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    StartingPoint = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Period = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlaceToVisits_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlaceToVisits_Tours_TourId",
                        column: x => x.TourId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightTickets_CategoryId",
                table: "FlightTickets",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightTickets_CityId",
                table: "FlightTickets",
                column: "CityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaceToVisits_CategoryId",
                table: "PlaceToVisits",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaceToVisits_TourId",
                table: "PlaceToVisits",
                column: "TourId");
