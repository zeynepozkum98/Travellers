...
namespace Travellers.DataAccess.Migrations
{
    ...
    partial class TravellersContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travellers.Entities.Concrete.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travellers.Entities.Concrete.WinterHoliday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FacilityAmenities")
                        .IsRequired()
                        .HasMaxLength(2000)
                    ...
                    b.ToTable("WinterHolidays");
                });

            modelBuilder.Entity("Travellers.Entities.Concrete.WinterHolidayOrder", b =>
                {
                    b.Property<int>("WinterHolidayId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("WinterHolidayId", "OrderId");

                    b.HasIndex("OrderId");

                    b.ToTable("WinterHolidayOrders");
                });
            ...
            modelBuilder.Entity("Travellers.Entities.Concrete.Order", b =>
                {
                    b.HasOne("Travellers.Entities.Concrete.AppUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Travellers.Entities.Concrete.WinterHolidayOrder", b =>
                {
                    b.HasOne("Travellers.Entities.Concrete.Order", "Order")
                        .WithMany("WinterHolidayOrders")
                        .HasForeignKey("OrderId")
                        .IsRequired();

                    b.HasOne("Travellers.Entities.Concrete.WinterHoliday", "WinterHoliday")
                        .WithMany("WinterHolidayOrders")
                        .HasForeignKey("WinterHolidayId")
                        .IsRequired();

                    b.Navigation("Order");

                    b.Navigation("WinterHoliday");
                });
            ...
            modelBuilder.Entity("Travellers.Entities.Concrete.Order", b =>
                {
                    b.Navigation("WinterHolidayOrders");
                });
